...
# Streamlit cache compatibility (st.cache_data introduced in newer versions)
try:
...
def load_data(url: str) -> pd.DataFrame:
    """Load the gold-price dataset from a remote CSV URL."""
...
def main() -> None:
    ...
    try:
        ...
        st.error("Unable to load dataset. Please check your network connection or the data URL.")
        st.exception(e)
        return
...
if __name__ == "__main__":
    try:
        ...
        # Surface the full error message in the app so it is visible in deployments
